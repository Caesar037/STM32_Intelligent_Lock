...
- 注释完整，内容较全，可用于初学，可随意修改
- 板子型号：STM32F407ZET6，其他硬件：FPM383C（指纹）、FR1002（人脸）、MFRC522（RFID）、AT24C02（EEPROM）、W25Q128（Flash）、ESP8266（WiFi）、DHT11、HC-SR04、OLED 128×64 显示屏，加上蜂鸣器、LED、按键与矩阵键盘
